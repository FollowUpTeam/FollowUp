...
import com.ipbase.followup.AppApplication;
import com.ipbase.followup.Config;
...
public class NewFriendConversation extends Conversation{
    ...
    public int getUnReadCount() {
        return NewFriendManager.getInstance(AppApplication.INSTANCE()).getNewInvitationCount();
    }

    @Override
    public void readAllMessages() {
        //批量更新未读未认证的消息为已读状态
        NewFriendManager.getInstance(AppApplication.INSTANCE()).updateBatchStatus();
    }
