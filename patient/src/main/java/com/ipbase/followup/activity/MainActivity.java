...
import com.ipbase.followup.fragment.main.ContactFragment;
import com.ipbase.followup.fragment.main.ConversationFragment;
import com.ipbase.followup.fragment.main.FollowUpFragment;
import com.ipbase.followup.fragment.main.SetFragment;
import com.ipbase.followup.model.bean.User;
import com.ipbase.followup.util.IMMLeaks;
 ...
 * 修改备注：
 */
public class MainActivity extends AbsViewActivity<MainPresenter> implements IMainView
{
    ...
    // 定义数组来存放Fragment界面
    protected final Class fragmentArray[] = {ConversationFragment.class, BingLiFragment.class, FollowUpFragment.class, DataFragment.class, SetFragment.class};
