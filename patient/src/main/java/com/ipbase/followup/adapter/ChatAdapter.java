...
public class ChatAdapter extends RecyclerView.Adapter<RecyclerView.ViewHolder>{
    ...
    //同意添加好友成功后的样式
    private final int TYPE_QUESTIONAIRE = 11;
    ...
    public RecyclerView.ViewHolder onCreateViewHolder(ViewGroup parent, int viewType) {
        ...
        }else if (viewType == TYPE_QUESTIONAIRE) {
            return new SendQuestionaireHolder(parent.getContext(), parent, c, onRecyclerViewListener);
    ...
    public int getItemViewType(int position) {
        ...
        if(message.getMsgType().equals(BmobIMMessageType.IMAGE.getType())){
            ...
            return TYPE_AGREE;
        }else if(message.getMsgType().equals("questionaire")) {
            return TYPE_QUESTIONAIRE;
        }else{
            return -1;
        }
    }
